...
public class PointScanner{
	...
	/**
	 * Carry outputFileName two rounds of sorting using the algorithm designated by sortingAlgorithm as follows:  
	 *    
	 *     a) Sort points[] by the x-coordinate to get the median x-coordinate. 
	 *     b) Sort points[] again by the y-coordinate to get the median y-coordinate.
	 *     c) Construct medianCoordinatePoint using the obtained median x- and y-coordinates.     
	 *  
	 * Based on the value of sortingAlgorithm, create an object of SelectionaSorter, InsertionaSorter, MergeaSorter,
	 * or QuickaSorter to carry outputFileName sorting.       
	 * @param algo
	 * @return
	 */
	public void scan()
	{
		//Determines what type of sorting algorithm will be used
		...
		Point xPt, yPt; //x and y points
		int x, y; // integers for x and y
	...
	/**
	 * outputFileNameputs performance statistics in the format: 
	 * 
	...
	/**
	 *  
	 * This method, called after scanning, writes point data into a file by outputFileNameputFileName. The format 
	 * of data in the file is the same as printed outputFileName from toString().  The file can help you verify 
